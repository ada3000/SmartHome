...
namespace iTeco.Lib.Srv
{
	...
	public sealed class ServiceConfigFileEx : ServiceMain.Config
	{
		...
		private sealed class Settings
		{
			...
			private void CheckFileReferences(XmlDocument doc)
			{
				...
				if (items != null && items.Count > 0)
				{
					...
					{
						string subXml = File.ReadAllText(AppDomain.CurrentDomain.BaseDirectory+elt.GetAttribute("file"));
